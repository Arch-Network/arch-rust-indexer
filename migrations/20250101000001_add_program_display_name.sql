...
WITH labels(program_id, display_name) AS (
    VALUES
        ...
        (encode(convert_to('apl-token00000000000000000000000','UTF8'),'hex'), 'APL Token Program'),
        (encode(convert_to('associated-token-account00000000','UTF8'),'hex'), 'Associated Token Account')
)
UPDATE programs p
